                    ...
                    <section>
                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                <div className="text-sm bg-slate-800/50 p-3 rounded-md mt-2 border border-slate-700">
                                    <p className="font-semibold text-slate-200 mb-2">
                                        ⚠️ <span className="underline">Naver API 키 발급 및 설정 방법 (필수)</span>
                                    </p>
                                    <p className="mb-2">
                                        '네이버 상위 블로그 분석' 기능을 사용하려면 API 키가 반드시 필요합니다. 아래 순서에 따라 발급받아 앱 우측 상단의 <strong className="text-cyan-400">설정(⚙️)</strong> 아이콘을 눌러 등록해주세요.
                                    </p>
                                    <ol className="list-decimal list-inside pl-2 space-y-1 mt-1">
                                        <li><a href="https://developers.naver.com" target="_blank" rel="noopener noreferrer" className="text-cyan-400 hover:underline">Naver Developers</a>에 접속하여 로그인합니다.</li>
                                        <li>상단 메뉴에서 <strong>'Application' &gt; '애플리케이션 등록'</strong>을 선택합니다.</li>
                                        <li>
                                            <strong>애플리케이션 이름</strong>을 '키워드 파이터' 등 식별하기 쉽게 입력합니다.
                                        </li>
                                        <li>
                                            <strong>사용 API</strong>에서 <strong>'검색'</strong>을 선택하여 추가합니다.
                                        </li>
                                        <li>
                                            <strong>환경 추가</strong>에서 <strong>'WEB 설정'</strong>을 선택하고, 웹 서비스 URL에 <code className="bg-slate-700 px-1 py-0.5 rounded text-yellow-300">http://localhost</code>를 입력합니다.
                                        </li>
                                        <li>'등록하기' 버튼을 누르면 애플리케이션이 생성됩니다.</li>
                                        <li>생성된 애플리케이션의 <strong>'Client ID'</strong>와 <strong>'Client Secret'</strong> 값을 복사하여 이 앱의 설정 창에 붙여넣고 저장합니다.</li>
                                    </ol>
                                </div>
                            </div>
                            <div>
