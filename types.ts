...
export interface NaverTrendKeyword {
  rank: number;
  keyword: string;
}

export interface NaverTrendCategory {
  name: string;
  slug: string;
}
...
export interface NaverTrendAnalysis {
  blogPosts: BlogPostData[];
  frequentKeywords: FrequentKeyword[];
  keywordBasedSuggestions: BlogStrategySuggestion[];
  analysisBasedSuggestions: BlogStrategySuggestion[];
}
...
export interface NewsBlogStrategyAnalysis {
  coreIssue: string;
  userInterestPoint: string;
  opportunity: string;
}

export interface NewsBlogStrategyReportData {
  analysis: NewsBlogStrategyAnalysis;
  suggestions: BlogStrategySuggestion[];
}
...
export type Feature = 'keywords' | 'blogs' | 'competition' | 'sustainable-topics' | 'related-keywords' | 'naver-trends' | 'naver-news';